...
module.exports = [
  ...
  { t: "About Khadija", d: "AI Search Manager at Wellows, Karachi, in search since 2018. Career, credentials, and the stack.", u: "/about/", g: "About", k: "about who is khadija zaman career experience background credentials nust koray wellows marketing manager lead karachi based location" },
  { t: "CV", d: "Two-page CV: roles since 2018, results with sources, tools built, training. HTML and PDF.", u: "/cv/", g: "CV", k: "cv resume curriculum vitae pdf download experience years senior lead hire hiring" },
  { t: "Start a conversation", d: "Hiring an AI search or SEO manager, full-time or contract? Tell me about the role.", u: "/contact/", g: "Contact", k: "contact hire email work together availability job role full-time contract" },
