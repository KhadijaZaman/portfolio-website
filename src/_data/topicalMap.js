  ...
  sections: [
    {
      ...
      entities: [
        ...
        { entity: "Content architecture", attributes: [
          ...
          { attr: "Semantic SEO framework (Koray Tuğberk's model) applied", url: "/blog/central-entity/", built: true, note: "Central entity chosen for Wellows, read against Google's topical entities patent" }
        ]},
