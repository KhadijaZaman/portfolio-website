...
module.exports = [
  ...
  { id: "wellows-impressions", figure: "680K → 3.78M", claim: "Google Search Console impressions, site-wide",
    property: "Wellows", window: "stated as 12 months", source: "Google Search Console", method: "measured",
    evidence: shot("gsctrafficgrowth.png"), evidenceLabel: "Search Console screenshot", verified: "2026-09-09", status: "window to confirm",
    note: "The screenshot on this site compares the last 3 months with the previous 3 months (7.27K clicks, 3.78M impressions). The site labels the growth as 12 months; the window needs to be stated once, consistently.",
    pages: ["wellows-ai-visibility", "home", "cv", "about"] },
