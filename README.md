...
src/
  ...
  posts/*.md            Blog posts      (Markdown → /blog/<slug>/), the outer section
  blog.njk              Blog index      (generated from posts)
  blog-category.njk     /blog/category/<slug>/ pages; categories live in _data/categories.js
  frameworks/           /frameworks/ hub (index.njk) + framework pages (Markdown → /frameworks/<slug>/)
  frameworks/r2a/*.md   R2A instruments (Markdown → /frameworks/r2a/<slug>/)
  research/             /research/ hub (index.njk) + study pages (Markdown → /research/<slug>/)
  ai-search-optimization.md, glossary.md   Scaffolds with permalink:false; publish per the content calendar
  sitemap.njk           sitemap.xml     (generated from every collection)
  ...
  _includes/
    ...
    post.njk            Blog post layout (+ BlogPosting/Breadcrumb JSON-LD)
    core.njk            Framework / instrument / study layout (+ CreativeWork or Article JSON-LD)
  ...
  .htaccess             Apache/LiteSpeed config for Hostinger (caching, security headers, 301s for moved pages)
