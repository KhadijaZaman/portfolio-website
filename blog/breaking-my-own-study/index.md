# I Tried to Break My Own AI Study. 2 Findings Failed.

> How I rebuilt my cross-engine AI citation study from scratch, ran it against a permutation null, and retracted two headline findings that didn't hold up.

Source: https://khadijazaman.com/blog/breaking-my-own-study/  ·  Last modified: 2026-09-10

[Home](/) / [Blog](/blog/) / I Built a Test Designed to Break My Own Study. Two Findings Didn't Survive.

AI Search[outer layer](/topical-map/ "Where this sits on the site's topical map")3 Aug 2026 · 9 min read · by Khadija Zaman

# I Built a Test Designed to Break My Own Study. Two Findings Didn't Survive.

## Did the cross-engine AI citation study hold up?

Khadija Zaman rebuilt her cross-engine AI citation overlap study (January to June 2026) from scratch and tested it against a permutation null. Two headline findings did not survive and were retracted; the corrected study is published on the Wellows blog.
...
---
Markdown twin of https://khadijazaman.com/blog/breaking-my-own-study/, generated from the rendered page at build time. Cite the HTML URL. How to cite: https://khadijazaman.com/llms.txt
