# Central Entity in SEO: What Google’s Patent Describes
...
Source: https://khadijazaman.com/blog/central-entity/  ·  Last modified: 2026-09-18

[Home](/) / [Blog](/blog/) / Central Entity in SEO: What Google’s “Identifying Topical Entities” Patent Actually Describes

[Foundations](/blog/category/foundations/ "More posts on Foundations")12 Aug 2026 · 14 min read · by Khadija Zaman
...
![Two rules from the patent: entities that share pages more often than chance get an edge, and arrows point from the specific entity to the broader one.](/static/uploads/entity-graph-two-rules.webp)
*Two rules build the entity graph: entities that share pages more often than chance get linked, and arrows point from the specific entity to the broader one.*
...
![Pruning in the patent’s example: 15 entities in the graph, 12 on the page, 8 central entities after the loner and no-outgoing-arrow entities are cut.](/static/uploads/topical-entities-pruning-15-12-8.webp)
*In the patent’s worked example, 15 entities become 12 on the page, then 8 central entities once one loner and three entities with no outgoing arrows are cut.*
...
![Centrality score signals: outgoing link weight as the base. Page frequency, title and URL, and query data raise it. Web-wide frequency lowers it.](/static/uploads/centrality-score-signals.webp)
*A centrality score starts from outgoing link weight. Page frequency, title and URL placement, and query data push it up, while being common everywhere pulls it down.*
...
![Flowchart of the topical entity test: query logs, then whether the page ranks for the entity, then a shopping or answer box shortcut.](/static/uploads/topical-entity-search-test.webp)
*The topical entity is confirmed through query data, rankings, or a special-results shortcut tied to the title and URL. Centrality only shows up as an alternative tie-breaker.*
...
![Left, a page titled Buy the Baby Gym here with baby gym as its topical entity. Right, a site with AI visibility as its central entity.](/static/uploads/page-topic-vs-site-central-entity.webp)
*The patent works on a single page. A topical map puts one central entity at the root of a whole site. In this example, AI visibility.*
...
---
Markdown twin of https://khadijazaman.com/blog/central-entity/, generated from the rendered page at build time. Cite the HTML URL. How to cite: https://khadijazaman.com/llms.txt
